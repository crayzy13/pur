...
class ChannelSelectionEPG(InfoBarButtonSetup):
    ...
    def __init__(self):
        ...
        self['recordingactions'] = HelpableActionMap(self, 'InfobarInstantRecord', {'ShortRecord': (self.RecordTimerQuestion, _('Add a record timer')),
         'LongRecord': (self.doZapTimer, _('Add a zap timer for next event'))}, -1)
    ...
    def RecordTimerQuestion(self):
        ...
        if eventidnext is not None:
            menu = [(menu1,
              'CALLFUNC',
              self.ChoiceBoxCB,
              self.doRecordCurrentTimer), (menu2,
              'CALLFUNC',
              self.ChoiceBoxCB,
